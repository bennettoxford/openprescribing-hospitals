            ...
            <div class="w-full lg:w-fit lg:min-w-[160px]">
                <span class="flex items-center gap-1 mb-1">
                    ...
                    <div class="relative inline-block group">
                        <button type="button" aria-label="Archived measures information" class="text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-oxford-500 flex items-center">
