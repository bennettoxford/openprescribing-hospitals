                      ...
                      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 px-3 py-3 break-words">
                          ...
                          <div class="grid grid-cols-[auto_1fr] gap-3 items-baseline">
                            <div class="flex items-center gap-1">
                              ...
                              <div class="relative inline-block group ml-2">
                                <button type="button" aria-label="Unlicensed status information" class="text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-oxford-500 flex items-center">
                        ...
                        <div class="space-y-3">
                          <div class="flex items-center border-b border-gray-200 pb-2">
                            ...
                            <div class="relative inline-block group ml-2">
                              <button type="button" aria-label="Quantity information details" class="text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-oxford-500 flex items-center">
                                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                  <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
                                </svg>
                              </button>
