...
from pipeline.bq_tables import UNITS_CONVERSION_TABLE_SPEC
...
@task
def import_unit_conversion(table_id: str, units_dict: Dict) -> List[Dict]:
...
def import_unit_conversion_flow():
    ...
    return import_unit_conversion(table_id, units_dict)
