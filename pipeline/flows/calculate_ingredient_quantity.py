...
def calculate_ingredient_quantity():
    ...
    validations = {
        "schema": validate_ingredient_quantity(),
        "ingredient_existence": validate_ingredients_exist(),
        "strength_info": validate_strength_info(),
        "direct_multiplication": validate_direct_multiplication(),
        "denominator_calculations": validate_denominator_calculations(),
    }
