...
from pipeline.flows.import_eric import (
...
def mock_bigquery_client():
    with patch("pipeline.flows.import_eric.get_bigquery_client") as mock_client:
        yield mock_client

@pytest.fixture
def mock_logger():
    with patch("pipeline.flows.import_eric.get_run_logger") as mock_logger:
        yield mock_logger
