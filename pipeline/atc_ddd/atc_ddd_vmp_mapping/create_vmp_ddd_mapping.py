...
from pipeline.setup.bq_tables import VMP_DDD_MAPPING_TABLE_SPEC, DMD_SUPP_TABLE_SPEC, WHO_DDD_TABLE_SPEC
...
def create_vmp_ddd_mapping():
    ...
    sql_file_path = Path(__file__).parent / "create_vmp_ddd_mapping.sql"
