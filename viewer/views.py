...
def filtered_quantities(request):
    ...
    try:
        predecessor_to_successor = {} # Maps predecessor org to successor org
        successor_orgs = {}  # Cache successor org details
        ...
        # Group data by VMP and target organisation (mapping predecessors to successors)
        grouped_data = {}
            ...
            if item.data:
                for entry in item.data:
                    ...
                    try:
                        ...
                        # merging predecessor data into successor
