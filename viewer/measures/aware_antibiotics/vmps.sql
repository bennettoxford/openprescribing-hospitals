...
WHERE 
    ...
    AND ofr.name NOT LIKE "%.intraarticular" -- remove products here and below which are ONLY for the below routes as the DDDs are not applicable to these routes
